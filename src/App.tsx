...
export default function App() {
  ...
  return (
    <div id="portfolio-container" className="min-h-screen bg-[#050505] text-zinc-100 font-sans selection:bg-blue-500/20 selection:text-blue-300 relative overflow-x-hidden">
      ...
      <nav id="navbar" className="sticky top-0 z-50 w-full bg-[#050505]/70 backdrop-blur-md border-b border-zinc-900/80 px-4 md:px-8 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6 text-xs text-zinc-400 font-mono font-medium">
            ...
            <a href="#projects" className="hover:text-blue-400 transition-colors">PORTOFOLIO PROYEK</a>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col text-left items-start">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 mt-10 w-full sm:w-auto">
              <a
                href="#projects"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white hover:bg-zinc-100 text-black text-xs sm:text-sm font-bold tracking-wide transition-all shadow-md active:scale-98"
              >
                <span>Lihat Koleksi Proyek</span>
                <ArrowRight className="w-4 h-4" />
              </a>
              <button
                onClick={handleCopyEmail}
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-zinc-950 hover:bg-zinc-900 border border-zinc-800 text-xs sm:text-sm font-bold tracking-wide text-zinc-300 transition-colors cursor-pointer"
              >
                <Mail className="w-4 h-4 text-blue-400" />
                <span>{copiedEmail ? 'Email Berhasil Disalin!' : 'Salin Surat Email'}</span>
              </button>
            </div>
      ...
      <div className="bg-zinc-950/40 border-y border-zinc-900/60 py-4 px-4 overflow-hidden select-none">
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-around gap-y-3 gap-x-6 text-[10px] sm:text-xs font-mono text-zinc-500 uppercase tracking-widest">
          ...
          <span className="flex items-center gap-2"><Sparkles className="w-4 h-4 text-indigo-500/80" /> Interaksi Desain UI/UX & Fungsional Maket</span>
          <span className="hidden sm:inline text-zinc-800">•</span>
